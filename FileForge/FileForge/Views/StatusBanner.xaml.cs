...
namespace FileForge.Views
{
    public partial class StatusBanner : UserControl
    {
        ...
        {
            Root.Background      = new SolidColorBrush(Color.FromRgb(0xF5, 0xF5, 0xF5));
            Root.BorderBrush     = new SolidColorBrush(Color.FromRgb(0xBD, 0xBD, 0xBD));
            TxtMsg.Foreground    = new SolidColorBrush(Color.FromRgb(0x61, 0x61, 0x61));
            TxtMsg.Text          = msg;
            Visibility           = Visibility.Visible;
        }
